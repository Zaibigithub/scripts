...
def main():
    ...
    while True:
        ...
        import sys
        waktu_tunggu = 5  # 5 menit dalam detik
...
def parse_arguments():
    ...
    if args.task is None:
        task_input = input("Apakah Anda ingin cek dan claim task? (y/n, default y): ").strip().lower()
        args.task = task_input if task_input in ['y', 'n'] else 'y'
